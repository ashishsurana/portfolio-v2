    ...
    <div className="flex experience-container">
      <div className="company-meta-container">
        ...
        <div
          ...
          style={{ top: journey.arr[1].top - 12 + "%" }}
        >
        ...
        <div
          ...
          style={{ top: journey.arr[2].top - 17 + "%" }}
        >
          <h3>
            <b>AadhaarAPI.com</b>
          </h3>
        ...
        <div className="company-meta" style={{ top: 80 + "%" }}>
          <SchoolIcon />
      ...
      <div className="flex col work-details">
        <div className="card">
          ...
          <ul>
            <li>
              About Level AI: Level AI is a startup that is building a platform
              for AI-powered customer service. I was part of the core team that
              maintains the core product. My responsibilities were as follows:
            </li>
            <li>
        ...
        <div className="card" style={{ top: "100px" }}>
        ...
        <div className="card" style={{ top: "110px" }}>
          ...
          <ul>
            ...
            <li>
              Ownership of development and releasing two modules in React using
        ...
        <div className="card" style={{ top: "150px" }}>
          ...
          <ul className="">
            <li>
              ...
              <b>1.4 Billion Indians</b> and AadhaarAPI is a product to leverage
              the power by developing SDKs over it. I worked on the back-end for
              the "<b>Know Your Customer</b>
              (EKYC)" using aadhaar APIs.
            </li>
            <li>
              Successfully delivered Dashboard from scratch and developed
              efficient <b>REST API</b>s for improving workflows.
            </li>
            <li>
